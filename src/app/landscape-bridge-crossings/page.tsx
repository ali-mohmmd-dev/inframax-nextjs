...
export default function LandscapeBridgeCrossings() {
  return (
    <>
   ...
   <div className="container mx-auto px-4 relative z-10 w-full">
    <div className="pb-[50px] min-h-[380px] md:pb-[90px] md:min-h-[380px] flex items-end justify-center text-center">
     <div className="will-change-transform w-full">
      <h1 className="heading-1 !mb-[10px] text-white tracking-wide font-semibold drop-shadow-sm">Landscape / Bridge Crossings</h1>
     </div>
    </div>
   </div>
  </section>
  ...
  {/*  â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
       OVERVIEW SOLUTIONS SECTION (Asymmetric Responsive Grid)
  â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•  */}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 items-center">
     ...
     <div className="flex flex-col justify-center space-y-6 lg:pr-16 py-4">
      <h2 className="heading-2 text-dark-blue font-bold tracking-tight">
       Landscape &amp; Bridge Crossing Solutions
      </h2>
      <p className="caption-text text-gray-600 leading-relaxed font-medium">
       Inframax provides trenchless solutions for installing pipelines beneath landscaped areas, bridges, and sensitive infrastructure zones. Our HDD and micro-tunneling techniques allow underground installations without disturbing surface structures or surrounding environments.
      </p>
      <p className="caption-text text-gray-600 leading-relaxed font-medium">
       This approach preserves architectural landscapes and structural foundations while ensuring efficient infrastructure development.
      </p>
     </div>
  ...
  <section className="w-full bg-dark-blue-bg pt-16 pb-16 lg:pt-20 lg:pb-20 relative overflow-hidden">
   ...
   <div className="container mx-auto px-4 max-w-7xl relative z-10">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
     ...
     <div className="flex flex-col justify-center space-y-8 lg:pl-16 py-4">
      ...
      <div className="flex flex-col justify-center space-y-6 lg:pr-16 py-4">
       ...
       <div className="flex items-start space-x-6 pb-4 border-b border-white/20">
        ...
        <p className="body-text !font-semibold text-white tracking-wide">
         Pipeline installation beneath bridges
        </p>
       </div>
       ...
       <div className="flex items-start space-x-6 pb-4 border-b border-white/20">
        ...
        <p className="body-text !font-semibold text-white tracking-wide">
         Crossings beneath landscaped areas
        </p>
       </div>
       ...
       <div className="flex items-start space-x-6 pb-4 border-b-0">
        ...
        <p className="body-text !font-semibold text-white tracking-wide">
         Infrastructure installation under sensitive structures
        </p>
       </div>
     ...
     <div className="flex flex-col space-y-6">
      ...
      <ul className="flex flex-col space-y-4">
       ...
       <li className="flex items-center space-x-4 caption-text text-[#555555] font-medium transition-transform duration-200 hover:-translate-y-0.5 cursor-default group">
        ...
        <span className="group-hover:text-dark-blue font-semibold transition-colors">Controlled drilling beneath structural foundations</span>
       </li>
       ...
       <li className="flex items-center space-x-4 caption-text text-[#555555] font-medium transition-transform duration-200 hover:-translate-y-0.5 cursor-default group">
        ...
        <span className="group-hover:text-dark-blue font-semibold transition-colors">Precision steering technology</span>
       </li>
       ...
       <li className="flex items-center space-x-4 caption-text text-[#555555] font-medium transition-transform duration-200 hover:-translate-y-0.5 cursor-default group">
        ...
        <span className="group-hover:text-dark-blue font-semibold transition-colors">Minimal surface disruption</span>
       </li>
